...
static const FieldInfo gGlobalPrefsFields[] = {
    ...
    {offsetof(GlobalPrefs, inverseSearchCmdLine), SettingType::String, (intptr_t) "openboardview.exe --reversesearch %f %s"},
    {offsetof(GlobalPrefs, enableTeXEnhancements), SettingType::Bool, true},
